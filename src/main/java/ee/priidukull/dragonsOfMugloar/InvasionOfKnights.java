...
public class InvasionOfKnights {
    ...
    public static void main(String[] args) throws UnirestException, IOException, UnexpectedResult, NoSuchFieldException, IllegalAccessException, CouldNotRank, CouldNotRank, CorrespondingDragonStrengthNotFound {
        int n = 100;
